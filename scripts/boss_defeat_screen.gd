...
func _play_reveal(scenario: Scenario, final_aura: float, time_bonus_ego: int, ego_points_before: int, ego_before: int) -> void:
	_reset_labels()
	visible = true
	modulate.a = 1.0
...
func _play_boss_ceremony(scenario: Scenario) -> void:
