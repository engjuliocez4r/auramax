...
##
## CLAUDE.md Rule 1: this is a class_name'd Resource script written outside
## the Godot editor. Every OTHER script that reads a Scenario instance must
## hold it in an UNTYPED var/param (never `: Scenario`), until the editor
## has rescanned the project and this class is in
## .godot/global_script_class_cache.cfg. See duel.gd, result_screen.gd,
## boss_card.gd, boss_defeat_screen.gd for the duck-typed access pattern.
